...
import { Info, Star, Mail as MailIcon, Phone, Facebook, Instagram, Menu } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans flex">
      {/* Sidebar */}
      <aside
      ...
      <div className="flex-1 ml-0 md:ml-64">
        ...
        <div className="flex justify-end px-4 mt-2">
          <button
            className="bg-gray-200 dark:bg-gray-800 text-sm px-3 py-1 rounded-md hover:bg-gray-300 dark:hover:bg-gray-700 transition"
        ...
        {/* About */}
        <section id="about" className="p-8 bg-gradient-to-br from-white to-blue-50 text-center flex flex-col items-center">
          <img
            src="/wz-vending-site/logo.png"
            alt="Zaroon Zayan Enterprise Logo"
            className="w-24 h-24 md:w-36 md:h-36 rounded-full shadow-lg mb-6"
          />
          <h2 className="text-2xl font-semibold mb-4">Smart Vending in London</h2>
          <p className="mb-4 max-w-2xl mx-auto">
            We bring state-of-the-art vending machines to student flats, shopping malls, and hospitals. Our machines provide 24/7 access to healthy snacks, drinks, and phone accessories – all via contactless payment.
          </p>
          <a href="mailto:contact@zaroonvending.co.uk">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="hover:shadow-lg transition-transform hover:scale-105">
              <CardContent className="p-6 text-center">
                <h3 className="font-bold text-lg text-blue-700 mb-2">Healthy Snacks</h3>
                <p>Granola bars, protein treats, and nutritious choices.</p>
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-transform hover:scale-105">
              <CardContent className="p-6 text-center">
                <h3 className="font-bold text-lg text-blue-700 mb-2">Cold Drinks</h3>
                <p>Water, juices, and refreshing beverages.</p>
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-transform hover:scale-105">
              <CardContent className="p-6 text-center">
                <h3 className="font-bold text-lg text-blue-700 mb-2">Chargers & Accessories</h3>
                <p>USB cables, earphones, and more on-the-go tools.</p>
              </CardContent>
            </Card>
          </div>
        </section>
        ...
        <section id="contact" className="p-8">
          ...
          <div className="flex flex-col gap-2 items-center">
            <p className="flex items-center gap-2">
              <MailIcon className="w-5 h-5" /> contact@zaroonvending.co.uk
            </p>
            <p className="flex items-center gap-2">
        ...
        {/* Footer */}
        <footer className="text-center text-sm p-4 bg-gray-200 text-gray-600 dark:bg-gray-700 dark:text-gray-300">
