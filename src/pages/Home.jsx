...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-gray-800" style={{ fontFamily: 'Aptos, sans-serif' }}>
      <section className="p-8 grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
        <div>
          <header className="bg-blue-900 text-white py-6 px-8 shadow-md mb-4">
            <h1 className="text-3xl font-bold">Zaroon Zayan Enterprise</h1>
            <p className="text-lg animate-fade-in-up opacity-100 transition-opacity duration-1000">
              Healthy • Classic • Charged
            </p>
          </header>
